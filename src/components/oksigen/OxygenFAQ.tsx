...
const AccordionItem: React.FC<{
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl sm:rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-slate-100 hover:border-primary/20 hover:shadow-lg transition-all duration-300"
    >
  ...
  return (
    <section className="relative py-16 sm:py-24 overflow-hidden">
      ...
      >
        ...
        <div className="absolute top-0 right-0 -translate-y-1/3 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-[radial-gradient(closest-side,rgba(78,113,255,0.05),transparent_70%)] blur-3xl" />
        <div className="absolute bottom-0 left-0 translate-y-1/3 w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] bg-[radial-gradient(closest-side,rgba(141,216,255,0.06),transparent_70%)] blur-3xl" />
      </div>
